...
public class XmlKeyboardLoader {
	...
	private static final String XMLATTR_SELECT_TEXT_COLOR = "key_select_text_color"; // 文本颜色.
	...
	private SoftKey getSoftKey(XmlResourceParser xrp, KeyCommonAttributes attrKey) {
		...
		int selectColor = getColor(xrp,XMLATTR_SELECT_TEXT_COLOR,attrKey.mSelectTextColor);
		//
		...
		softKey.setSelectTextColor(selectColor);
	...
	class KeyCommonAttributes {
		...
		int mSelectTextColor = Color.BLACK;
		...
		boolean getAttributes(KeyCommonAttributes defAttr) {
			...
			this.mSelectTextColor = getColor(mXrp, XMLATTR_SELECT_TEXT_COLOR, defAttr.mSelectTextColor); // 按键文本颜色.
			return true;
		}
	}
