...
//        leftButton = (LinearLayout) findViewById(R.id.left_button);
//        rightButton = (LinearLayout) findViewById(R.id.right_button);
        selectButton = (LinearLayout) findViewById(R.id.select_button);
...
//                Toast.makeText(getContext(), "left long clicked", Toast.LENGTH_SHORT).show();
//                return false;
//            }
//        });
...
//            @Override
//            public boolean onLongClick(View v) {
//                Toast.makeText(getContext(), "right long clicked", Toast.LENGTH_SHORT).show();
//                return false;
//            }
//        });
...
//            Toast.makeText(getContext(), "left short click", Toast.LENGTH_SHORT).show();
//        } else if(i == R.id.right_button) {
//            Toast.makeText(getContext(), "right short click", Toast.LENGTH_SHORT).show();
//        }
        else if(i == R.id.select_button) {
            mItemListener.onItemClick(R.id.select_button);
            Toast.makeText(getContext(), "select lessons", Toast.LENGTH_SHORT).show();
        }
    }

    public void SetMenuButtonFocus() {
        if(!selectButton.hasFocus())
            selectButton.requestFocus();
    }

    public void SetSeekBarFocus() {
        if(!progressBar.hasFocus())
    ...
    public void seekToPosition(int pos) {
        JCMediaManager.instance().mediaPlayer.seekTo(pos);
        int duration = getDuration();
        int progress = pos * 100 / (duration == 0 ? 1 : duration);
        progressBar.setProgress(progress);
        currentTimeTextView.setText(JCUtils.stringForTime(pos));
    }
