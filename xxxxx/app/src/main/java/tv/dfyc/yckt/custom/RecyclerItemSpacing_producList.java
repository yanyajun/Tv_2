...
public class RecyclerItemSpacing_producList extends RecyclerView.ItemDecoration {
    private int left_space;
    private int top_space;
    private int right_space;
    private int bottom_space;

    public RecyclerItemSpacing_producList(int left, int top, int right, int bottom) {
